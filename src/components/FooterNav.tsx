...
const FooterNav = () => {
  ...
  return (
    <div className={`border-4 border-danger pb-5 border-top${location.pathname === "/cart" || location.pathname === "/settings" || location.pathname === "/signup" || location.pathname === "/login" ? ' d-none' : ''}`}>
