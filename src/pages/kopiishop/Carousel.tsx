const carouselData = [
  {
    ...
    title: '30% OFF',
    desc: 'Experience the precision of our state-of-the-art machines, bringing you the perfect cup of coffee with every pour.'
  },
  {
    id: 1,
          ...
          {carouselData.map((item, index) => (
            <div key={index} className={`carousel-item ${index === 0 ? "active" : ""}`}>
              ...
              <div className="carousel-caption d-none d-md-block text-danger">
                ...
                <p className="text-light lead rounded bg-opaque">{item.desc}</p>
              </div>
            </div>
          ))}
        </div>
