...
const featuresData = [
  {
    imgSrc: "https://kopiiiiiimg.netlify.app/assets/images/vision.jpg",
  ...
  {
    imgSrc: "https://kopiiiiiimg.netlify.app/assets/images/mission.jpg",
          ...
          {featuresData.map((feature, index) => (
            <Div key={index} styles={`row gap-5 justify-content-center align-items-center ${index === 0 ? 'mt-2': 'mt-5'}`}>
              <div className="col-5 text-center d-none d-lg-block">
                <img className="img-fluid shadow" src={feature.imgSrc} alt="" />
              </div>
              ...
              <Div key={index} styles="col-lg-4 shadow-lg">
                <div className="card bg-danger bs-danger border-0 p-2">
                  <div className="card-body text-info">
                    <i className={`fa-solid ${feature.iconClass} fs-3 mb-3`}></i>
